...
//            print("Nem prím")
        ...
        if(also > felso){
            //csere algoritmusa
            System.out.println("Megcseréltem...");
            int seged = also;
            also = felso;
            felso = seged;
        }
        ...
        //kiválasztás:
        if (van){
            System.out.printf("Alsó és a felső határok között van 0-ra végződő szám:%d ", i );
        }else{
            System.out.println("Alsó és a felső határok között nincs 0-ra végződő");
        }
    }//main vége
